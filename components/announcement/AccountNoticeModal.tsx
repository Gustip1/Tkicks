  ...
  return (
    ...
    >
      <div
        ...
        className="notice-card animate-notice-card relative my-auto w-full max-w-lg overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-zinc-900 via-black to-zinc-900 p-6 shadow-2xl shadow-black/60 sm:p-8"
      >
        ...
        <div className="relative">
          ...
          <p id="account-notice-lead" className="mt-3 text-sm leading-relaxed text-zinc-300 sm:text-base">
            {ACCOUNT_NOTICE.lead}
          </p>

          <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            <p className="flex gap-3 text-sm leading-relaxed text-zinc-300">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/20 px-4 py-3 text-sm font-black text-white outline-none transition-colors hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/60"
            >
              {ACCOUNT_NOTICE.tiktokLead}: {TIKTOK_HANDLE}
            ...
            <button
              type="button"
              onClick={accept}
              className="inline-flex flex-1 items-center justify-center rounded-xl bg-white px-6 py-3 text-sm font-black uppercase tracking-wider text-black outline-none transition-transform hover:bg-zinc-100 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black active:scale-95"
            >
