    ...
    <section className="bg-white py-12 md:py-20 border-t border-gray-200">
      <div className="max-w-[1400px] mx-auto px-4">
        ...
        <div className="flex items-end justify-between mb-10 md:mb-14">
          <div>
            <p className="text-xs text-gray-400 font-bold mb-2">Simple y seguro</p>
        ...
        <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/productos"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-primary text-white text-sm font-normal rounded-full hover:bg-primary-hover transition-all"
          >
            Ver catálogo <ArrowRight className="w-4 h-4" />
          </Link>
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 border border-gray-300 text-gray-900 text-sm font-black rounded-full hover:bg-gray-50 transition-all"
          >
